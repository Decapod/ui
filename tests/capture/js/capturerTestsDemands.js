...
(function ($) {
    ...
    fluid.demands("cameraStatusSource", ["decapod.fileSystem", "decapod.test"], {
        options: {
            url: "../../../mock-data/capture/mockCameraStatus.json"
        }
    });
    
    fluid.demands("captureStatusSource", ["decapod.fileSystem", "decapod.test"], {
        options: {
            url: "../../../mock-data/capture/mockCaptureStatus.json"
        }
    });
    
    fluid.demands("imageSource", ["decapod.fileSystem", "decapod.test"], {
        options: {
    ...
    fluid.demands("deleteStatusSource", ["decapod.fileSystem", "decapod.test"], {
        options: {
            url: "../../../mock-data/capture/mockImagesByIndex.json"
        }
    });
